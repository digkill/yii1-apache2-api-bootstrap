...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $this->module->assetsUrl; ?>/src/public/css/screen.css" media="screen, projection" />
	<link rel="stylesheet" type="text/css" href="<?php echo $this->module->assetsUrl; ?>/src/public/css/print.css" media="print" />
	<!--[if lt IE 8]>
    <link rel="stylesheet" type="text/css" href=<?php echo
          $this->module->assetsUrl; ?>"/src/public/css/ie.css" media="screen, projection" />
    <![endif]-->

	<link rel="stylesheet" type="text/css" href="<?php echo $this->module->assetsUrl; ?>/src/public/css/main.css" />
